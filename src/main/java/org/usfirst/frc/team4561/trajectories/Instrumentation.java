...
public class Instrumentation {
	...
	public static void process(MotionProfileStatus status, double pos,
		...
		if ((now - timeout) > 0.05) {
			...
			System.out.format("%-9s\t", (status.activePointValid ? "True" : "False"));
			System.out.format("%-9s\t", (status.hasUnderrun ? "True" : "False"));
			System.out.format("%-9s\t", (status.isUnderrun ? "True" : "False"));
			System.out.format("%-9s\t", (status.isLast ? "True" : "False"));
